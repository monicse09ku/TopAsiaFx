...
class Faqs extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('page, title, description, create_date, update_date', 'required'),
			array('page', 'length', 'max'=>200),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, page, title, description, create_date, update_date', 'safe', 'on'=>'search'),
		);
	}
