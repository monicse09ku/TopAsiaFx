...
/**
 * This is the model class for table "no_deposit_bonuses".
 *
 * The followings are the available columns in table 'no_deposit_bonuses':
 * @property integer $id
 ...
 */
class NoDepositBonuses extends CActiveRecord
{
	/**
	 ...
	 * @return NoDepositBonuses the static model class
	 */
