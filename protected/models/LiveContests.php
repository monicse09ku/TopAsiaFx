...
/**
 * This is the model class for table "live_contests".
 *
 * The followings are the available columns in table 'live_contests':
 * @property integer $id
 ...
 */
class LiveContests extends CActiveRecord
{
	/**
	 ...
	 * @return LiveContests the static model class
	 */
