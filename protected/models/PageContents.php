...
class PageContents extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('url, create_date, update_date', 'required'),
			array('url', 'length', 'max'=>191),
			array('top_content, bottom_content', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, url, top_content, bottom_content, create_date, update_date', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('top_content',$this->top_content,true);
		$criteria->compare('bottom_content',$this->bottom_content,true);
