...
/**
 * This is the model class for table "deposit_bonuses".
 *
 * The followings are the available columns in table 'deposit_bonuses':
 * @property integer $id
 ...
 */
class DepositBonuses extends CActiveRecord
{
	/**
	 ...
	 * @return DepositBonuses the static model class
	 */
