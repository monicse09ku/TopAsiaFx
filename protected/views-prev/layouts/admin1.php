        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/user_images/avatar5.png" class="user-image" alt="User Image">
              <span class="hidden-xs">Alexander Pierce</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/user_images/avatar5.png" class="img-circle" alt="User Image">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo Yii::app()->createAbsoluteUrl('test/create/'); ?>"><i class="fa fa-circle-o"></i> Create Test</a></li>
            <li><a href="<?php echo Yii::app()->createAbsoluteUrl('test/admin'); ?>"><i class="fa fa-circle-o"></i> Manage Tests</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo Yii::app()->createAbsoluteUrl('ques/create/'); ?>"><i class="fa fa-circle-o"></i> Create Question</a></li>
            <li><a href="<?php echo Yii::app()->createAbsoluteUrl('ques/admin'); ?>"><i class="fa fa-circle-o"></i> Manage Questions</a></li>
