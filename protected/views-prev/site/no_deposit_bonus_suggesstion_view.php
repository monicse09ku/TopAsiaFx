...
<?php } ?>
<?php 
if(count($no_deposit_bonus_suggestions) > 0){
	foreach ($no_deposit_bonus_suggestions as $no_deposit_bonus_suggestion) {
?>
...
<div class="row single-comment">
	...
	<div class="col-md-10">
		<div class="row">
			<div class="col-md-12">
				<p class="commenter-name">
					<?php echo ucfirst($no_deposit_bonus_suggestion['name']);?>
				</p>
				<p class="comment-date">
					<?php echo date('jS M, Y', strtotime($no_deposit_bonus_suggestion['create_date']));?>
				</p>
			</div>
		</div>
		<hr class="comment-hr">
		<div class="row">
			<div class="col-md-12">
				<p class="comment">
					<?php echo $no_deposit_bonus_suggestion['suggestion'];?>
				</p>
			</div>			
		</div>
	</div>
