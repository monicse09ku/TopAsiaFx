    ...
    <div class="box-body">
        <div class="stars">
            <div class="users-comments">
                <h3 class="deposit-bonus-header" style="margin-top: 30px;margin-bottom: 20px;color: #034aa2;">Leave Your Valuable Comments:</h3>
            </div>
            <!-- <p class="note">Fields with <span class="required">*</span> are required.</p> -->
            <form action="" method="post" id="prospects_form">
                <div class="form-group row">
                    <input type="hidden" name="broker_id" value= "<?php echo $this_broker['id'];?>">
                </div>
                ...
                <div class="form-group col-md-12">
                    <label>Comment</label>
                    <textarea type="text" name="comment" id="comment_text" class= "form-control" rows="7"></textarea>
                    <span id="characters_left" class="pull-right" style="color:red;">Maximum 1000 Characters</span>
                </div>
            
                <div class="form-group col-md-12 col-xs-12 star_rating">
