...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'deposit-bonuses-review-form',
	...
	<div class="form-group">
		<?php echo $form->labelEx($model,'deposit_bonuses_id'); ?>
		<?php echo $form->textField($model,'deposit_bonuses_id', array ('class' => 'form-control')); ?>
		<?php echo $form->error($model,'deposit_bonuses_id'); ?>
	</div>
