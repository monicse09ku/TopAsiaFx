...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group col-md-4">
		...
		<?php echo $form->textField($model,'title', array ('class' => 'form-control', 'id' => 'demo-contests-title')); ?>
		<?php echo $form->error($model,'title'); ?>
	</div>

	<div class="form-group col-md-4">
		<?php echo $form->labelEx($model,'url'); ?>
		<?php echo $form->textField($model,'url', array ('class' => 'form-control', 'id' => 'demo-contests-url')); ?>
...
<script type="text/javascript">
    ...
    tinymce.init({
 	...
 	$( "#demo-contests-title" ).keyup(function() {
    	var permalink = '';
        var title = $("#demo-contests-title").val();

        if(title.length > 0){
            permalink = editPermalink(title);
        }
        //alert(permalink);
        $("#demo-contests-url").val(permalink);
        $("#demo-contests-url").html(permalink);
    });
