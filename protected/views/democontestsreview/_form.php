...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group col-md-3">
		<?php echo $form->labelEx($model,'demo_contests_id'); ?>
		<?php echo $form->textField($model,'demo_contests_id', array ('class' => 'form-control')); ?>
		<?php echo $form->error($model,'demo_contests_id'); ?>
	</div>
