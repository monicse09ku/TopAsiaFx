<div class="col-md-8 col-md-offset-2 table-margin">
    ...
    <div class="form box-primary">
        ...
        <div class="box-body">
            <div class="stars">
                <form action="" method="post" id="demo_contest_suggestion_form">
                    <div class="form-group col-md-12" id="alert-box" style="padding: 0">
                    
                    </div>
                    <div class="form-group row">
                        <label>Name</label>
                        <input type="text" name="name" class= "form-control demo_contest_suggestion_name">
                    </div>
    
                    <div class="form-group row">
                        <label>Suggesstion</label>
                        <textarea type="text" name="comment" id="comment_text" class="form-control demo_contest_suggestion_comment" rows="7"></textarea>
