...
<div class="container">    
    ...
    <?php if(!empty($banner_data[1])){?>
        <div class="top_banner">
        <?php echo $banner_data[1]['code'];?>
        </div>
    <?php } ?>
    ...
    <?php if(!empty($banner_data[2])){?>
        <div class="outer_left">
            <div class="inner_left">
                <?php echo $banner_data[2]['code'];?>
            </div>
        </div>        
    <?php } ?>

    <?php if(!empty($banner_data[3])){?>
        <div class="outer_right">
            <div class="inner_right">
                <?php echo $banner_data[3]['code'];?>
            </div>
        </div>                
    <?php } ?>
            ...
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="item <?php if($counter <= 1){echo " active"; } ?>">
                        ...
                        <a style="margin-top:33px;margin-left:20px;float:left" class="read_review_link" href="<?php echo Yii::app()->request->getBaseUrl(true); ?>/best-forex-broker/<?php echo $broker_data['broker_url'] ?>">Read the Full Review</a>
                    </div>
                    <?php
                        }
                        ?>
