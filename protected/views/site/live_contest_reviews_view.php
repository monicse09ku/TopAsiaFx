<?php 
if(count($live_contests_reviews) > 0){
	foreach ($live_contests_reviews as $live_contests_review) {
?>
...
<div class="row single-comment">
	...
	<div class="col-md-10">
		<div class="row">
			<div class="col-md-7">
				<p class="commenter-name">
					<?php echo ucfirst($live_contests_review['name']);?>
					<span class="commenter-country"> 
					from <?php echo ucfirst($live_contests_review['country']);?>
					</span>
				</p>
				<p class="comment-date">
					<?php echo date('jS M, Y', strtotime($live_contests_review['create_date']));?>
				</p>
			</div>
			...
			<div class="col-md-5">
				<?php 
					for ($i=1; $i < 6; $i++) { 
						if($i <= $live_contests_review['score']){
		...
		<div class="row">
			<div class="col-md-12">
				<p  class="comment">
					<?php echo $live_contests_review['comment'];?>
				</p>
			</div>			
		</div>
	</div>
