...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group col-md-4">
		...
		<?php echo $form->textField($model,'title', array ('class' => 'form-control', 'id' => 'live-contests-title')); ?>
		<?php echo $form->error($model,'title'); ?>
	</div>

	<div class="form-group col-md-4">
		<?php echo $form->labelEx($model,'url'); ?>
		<?php echo $form->textField($model,'url', array ('class' => 'form-control', 'id' => 'live-contests-url')); ?>
...
<script type="text/javascript">
    ...
    tinymce.init({
 	...
 	$( "#live-contests-title" ).keyup(function() {
    	var permalink = '';
        var title = $("#live-contests-title").val();

        if(title.length > 0){
            permalink = editPermalink(title);
        }
        //alert(permalink);
        $("#live-contests-url").val(permalink);
        $("#live-contests-url").html(permalink);
    });
