	...
	'components'=>array(
		...
		'urlManager'=>array(
			...
			'rules'=>array(
			    ...
			    '<action:forex-demo-contests>'=>'site/democontests',
			    '<action:forex-demo-contests>/<url>'=>'site/democontests',
			    '<action:forex-live-contests>'=>'site/livecontests',
			    '<action:forex-live-contests>/<url>'=>'site/livecontests',
